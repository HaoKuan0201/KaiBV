-- Supabase SQL: Create Trips Table for KaiBankVault (Updated with Public Read Access)
...
CREATE INDEX idx_trips_is_public ON public.T_KaiBankVault_Trips(is_public);
